...
<main>
    <x-sections.service-pages.hero 
        ...
        :subtitle="__('messages.services_detail.dental_implants.description')"
        :killerLine="__('messages.services_detail.dental_implants.killer_line')"
    />
    ...
    <x-sections.service-pages.why-choose-us 
        :items="__('messages.services_detail.dental_implants.why_choose_us')"
    />
