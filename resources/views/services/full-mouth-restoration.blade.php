...
@section('title', __('messages.services_detail.full_mouth_restoration.title') . ' - ' . config('app.name'))

@section('content')
<main>
    <x-sections.service-pages.hero 
        :title="__('messages.services_detail.full_mouth_restoration.title')"
        :subtitle="__('messages.services_detail.full_mouth_restoration.description')"
        :killerLine="__('messages.services_detail.full_mouth_restoration.killer_line')"
    />
    ...
    <x-sections.service-pages.why-choose-us 
        :items="__('messages.services_detail.full_mouth_restoration.why_choose_us')"
    />
