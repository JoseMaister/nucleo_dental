...
@section('title', __('messages.services_detail.dentures.title') . ' - ' . config('app.name'))

@section('content')
<main>
    <x-sections.service-pages.hero 
        :title="__('messages.services_detail.dentures.title')"
        :subtitle="__('messages.services_detail.dentures.description')"
        :killerLine="__('messages.services_detail.dentures.killer_line')"
    />
