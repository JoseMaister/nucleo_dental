...
@section('title', __('messages.services_detail.cosmetic_dentistry.title') . ' - ' . config('app.name'))

@section('content')
<main>
    <x-sections.service-pages.hero 
        :title="__('messages.services_detail.cosmetic_dentistry.title')"
        :subtitle="__('messages.services_detail.cosmetic_dentistry.description')"
