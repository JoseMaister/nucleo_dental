    ...
    <div class="relative aspect-[4/3] overflow-hidden bg-gray-200">
        ...
        <div class="flex h-full w-full">
            <div class="relative w-1/2 h-full overflow-hidden border-r border-white/20">
                <img src="{{ $case['before_image'] }}" alt="Before" class="absolute inset-0 w-full h-full object-cover grayscale-[0.2] group-hover:grayscale-0 transition-all duration-500">
            ...
            <div class="relative w-1/2 h-full overflow-hidden">
                <img src="{{ $case['after_image'] }}" alt="After" class="absolute inset-0 w-full h-full object-cover">
