<div class="relative bg-gray-300 p-10 my-18 pb-[8rem]">
    <div class="text-indigo-800 text-center text-3xl md:text-5xl font-thin">
        <strong>Payments</strong> Methods
    </div>
    ...
    <div class="text-indigo-800 text-center text-2xl md:text-4xl font-bold">
        We Make It Easy to Pay for Your Smile
    </div>
    <div class="text-gray-700 mb-12 text-center text-2xl font-light px-6 mt-12">
        We accept a wide range of payment options to make your treatment as convenient as possible. Choose the method that fits you best whether you’re local or visiting from abroad.
    </div>
    <div class="bg-white rounded-[50px] flex flex-col md:flex-row items-center justify-center md:gap-12 gap-6 p-10">
        ...
        <div class="flex-1">
            <div class="text-4xl mb-6 font-bold text-indigo-800">Accepted Methods</div>
            <ul class="list-disc list-inside text-2xl text-gray-500">
                <li>Credit & debit cards (Visa, MasterCard, American Express)</li>
                <li>Cash payments (USD & MXN)</li>
                <li>Bank transfers</li>
                <li>Dental financing programs (with flexible monthly plans)</li>
                <li>Paypal</li>
            </ul>
        </div>
    </div>
    <div class="absolute flex w-[90%] flex-col md:flex-row z-10 -bottom-[8%] left-[50%] -translate-x-[50%] bg-gray-400 rounded-[50px] px-12 py-6 gap-6">
        <div class="flex-1 text-left">
            <div class="text-2xl font-bold text-indigo-800">Need help choosing the best option?</div>
            <div class="font-light text-lg text-white">Our team is ready to assist you before <br/>
your appointment.</div>
        </div>
        <div class="flex justify-center items-center">
            <a href="{{ route('contact') }}" class="border border-white border-[4px] px-20 py-3 rounded-full hover:bg-gray-200 font-bold text-white">Contact Us</a>
        </div>
    </div>
</div>