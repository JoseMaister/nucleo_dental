<div class="relative bg-gray-300 p-10 my-18 pb-[8rem]">
    <div class="text-indigo-800 text-center text-3xl md:text-5xl font-thin">
        <strong>{{ __('messages.financing_payment.title1') }}</strong> {{ __('messages.financing_payment.title2') }}
    </div>
    ...
    <div class="bg-white rounded-[50px] flex flex-col md:flex-row items-center justify-center md:gap-12 gap-6 p-10">
        ...
        <div class="flex-1">
            <div class="text-4xl mb-6 font-bold text-indigo-800">{{ __('messages.financing_payment.accepted_methods') }}</div>
...
<div class="absolute flex w-[90%] max-w-4xl flex-col md:flex-row z-10 -bottom-[8%] left-1/2 -translate-x-1/2 bg-gray-400 rounded-[50px] px-6 md:px-12 py-6 gap-6 mx-auto">
        ...
        <div class="flex justify-center items-center">
            <a href="{{ route('contact') }}" class="border border-white border-[4px] px-20 py-3 rounded-full hover:bg-gray-200 font-bold text-white">{{ __('messages.financing_payment.contact_us') }}</a>
        </div>
    </div>
</div>