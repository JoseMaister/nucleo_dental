<section class="relative">
    ...
    <div class="absolute top-[50px] left-6 md:left-10 transform  text-white max-w-xl">
        <h2 class="text-2xl md:text-4xl font-bold leading-tight">{!! __('messages.hero.title') !!}</h2>
